# Keyword Map Audit Template

## Purpose

Guide a future read-only Run reviewing primary/secondary queries, intent, target URLs, URL types, funnel stage, cannibalization, ranking evidence, priority, status, and internal links.
...
keyword tools, sanitized Search Console summaries, SERP review notes, repository content inventory. Listing a source does not authorize access.

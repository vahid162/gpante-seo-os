...
Guide a future read-only Run reviewing hub/supporting-page relationships, product/category connections, intent coverage, internal links, gaps, overlaps, and business priority.
...
keyword map, content inventory, internal-link crawl, SERP observations. Listing a source does not authorize access.

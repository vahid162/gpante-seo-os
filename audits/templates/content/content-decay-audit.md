# Content Decay Audit Template

## Purpose

Guide a future read-only Run reviewing declining pages, freshness, intent shifts, lost rankings/clicks, outdated product references, and refresh candidates.
...
sanitized Search Console/analytics summaries, content inventory, SERP review. Listing a source does not authorize access.

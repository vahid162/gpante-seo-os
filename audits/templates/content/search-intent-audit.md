# Search Intent Audit Template

## Purpose

Guide a future read-only Run reviewing transactional product, commercial investigation, category, informational, comparison, brand, and support/troubleshooting intent alignment.
...
SERP review, query evidence, current landing pages, competitor page types. Listing a source does not authorize access.

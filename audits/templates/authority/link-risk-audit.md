# Link Risk Audit Template

## Purpose

Guide a future read-only Run reviewing toxic-link signals, manual-action evidence, spam patterns, relevance, disavow thresholds, and approval requirements.
...
backlink tool summaries, Search Console manual action summary if sanitized, manual review. Listing a source does not authorize access.

# Backlink Profile Audit Template

## Purpose

Guide a future read-only Run reviewing linking domains, relevance, anchor patterns, link context, evidence, risk signals, and unsupported claims.
...
backlink tool summaries, manual review notes, sanitized exports. Listing a source does not authorize access.

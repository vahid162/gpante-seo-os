# Competitor Link Gap Audit Template

## Purpose

Guide a future read-only Run reviewing competitor linking domains, opportunity relevance, content assets, relationship status, evidence, and approval needs.
...
backlink tool summaries, public page review, prospect notes. Listing a source does not authorize access.

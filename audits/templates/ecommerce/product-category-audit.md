# Product Category Audit Template

## Purpose

Guide a future read-only Run reviewing category demand, inventory depth, copy, pagination, filters, internal links, sitemap inclusion, and merchandising value.
...
crawler data, keyword evidence, sanitized inventory/category summaries. Listing a source does not authorize access.

...
Guide a future read-only Run reviewing product indexability, canonical, descriptions, variations, images, reviews, price, availability, schema, internal links, out-of-stock and discontinued handling.
...
crawler data, sanitized WooCommerce summaries, rendered product checks, Search Console summaries. Listing a source does not authorize access.

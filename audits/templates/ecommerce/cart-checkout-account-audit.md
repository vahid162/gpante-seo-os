# Cart Checkout Account Audit Template

## Purpose

Guide a future read-only Run reviewing cart, checkout, account, login, add-to-cart, REST cart endpoint, WooCommerce AJAX, price/availability, schema side effects, and cache safety.
...
browser user-flow observations, response headers, sanitized configuration summaries. Listing a source does not authorize access.

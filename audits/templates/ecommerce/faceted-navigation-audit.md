# Faceted Navigation Audit Template

## Purpose

Guide a future read-only Run reviewing attribute/filter URLs, layered navigation, parameter combinations, crawl demand, duplicate risk, business value, and indexability candidates.
...
crawler data, sanitized log summaries, keyword evidence, category inventory summaries. Listing a source does not authorize access.

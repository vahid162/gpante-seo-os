# WooCommerce Runtime Audit Template

## Purpose

Guide a future read-only Run reviewing runtime SEO effects from WooCommerce templates, fragments, sessions, Store API, REST, wc-ajax, cache state, and product data output.
...
browser checks, response headers, sanitized performance summaries, WooCommerce configuration summaries. Listing a source does not authorize access.

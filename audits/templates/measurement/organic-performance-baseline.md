# Organic Performance Baseline Template

## Purpose

Guide a future read-only Run reviewing organic sessions, product views, add-to-cart, checkout starts, conversions, revenue, and revenue per organic session.
...
sanitized analytics and WooCommerce aggregate summaries. Listing a source does not authorize access.

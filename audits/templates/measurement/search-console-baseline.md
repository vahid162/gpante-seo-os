# Search Console Baseline Template

## Purpose

Guide a future read-only Run reviewing clicks, impressions, CTR, average position, indexed URL count, sitemap coverage, query/page/device segmentation, and limitations.
...
sanitized Search Console summaries only. Listing a source does not authorize access.

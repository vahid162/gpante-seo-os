# SEO KPI Audit Template

## Purpose

Guide a future read-only Run reviewing search visibility, ecommerce, and technical KPI definitions, source quality, segmentation, reporting frequency, and limitations.
...
measurement configuration summaries, sanitized reports, repository KPI dictionary. Listing a source does not authorize access.

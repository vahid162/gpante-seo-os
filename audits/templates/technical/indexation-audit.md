# Indexation Audit Template

## Purpose

Guide a future read-only Run reviewing indexability, noindex, canonical, sitemap eligibility, Search Console summaries, URL inspection summaries, and URL-class conflicts.
...
sanitized Search Console summaries, crawler data, HTML meta robots, canonical tags, sitemap files. Listing a source does not authorize access.

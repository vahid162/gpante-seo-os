# Crawl Audit Template

## Purpose

Guide a future read-only Run reviewing crawl discovery, status patterns, crawl traps, orphan URLs, pagination, internal links, robots directives, and sitemap coverage.
...
crawler exports, sanitized log summaries, XML sitemaps, rendered page checks, robots.txt, repository records. Listing a source does not authorize access.

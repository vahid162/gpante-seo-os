...
Guide a future read-only Run reviewing TTFB, LCP, INP, CLS, cache HIT/BYPASS context, anonymous/authenticated differences, static/dynamic templates, and mobile/desktop results.
...
synthetic tests, field summaries, response headers, sanitized server timing summaries. Listing a source does not authorize access.

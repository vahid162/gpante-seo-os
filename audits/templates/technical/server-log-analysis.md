# Server Log Analysis Template

## Purpose

Guide a future read-only Run reviewing bot crawl demand, URL-class crawl waste, 4xx/5xx patterns, redirect hits, slow dynamic endpoint categories, and cache context.
...
sanitized aggregate log summaries only; raw logs are reference-only. Listing a source does not authorize access.
